...
# --- CONFIGURATION ---
# API_KEY = "5795b0ea3ef08419aaa86797bf2afeb4"
API_KEY =  "https://api.openweathermap.org/data/2.5/forecast?q=Nagpur&appid=5795b0ea3ef08419aaa86797bf2afeb4&units=metric"
UNITS = "metric"  # or "imperial"
DAYS = 5  # This API gives data in 3-hour intervals (so ~8 entries/day)

# --- FETCH WEATHER DATA ---
def fetch_weather_data(city, api_key, units):
    url = f"http://api.openweathermap.org/data/2.5/forecast?q=Nagpur&appid=5795b0ea3ef08419aaa86797bf2afeb4"
